...
class CondominiumControllerTest {
    ...
    void listReturnsCondominiumsFromService() throws Exception {
        ...
        when(service.listForCurrentUser()).thenReturn(List.of(
                new CondominiumSummary(id, "Condo Teste", UserRoleInCondo.ADMIN)));
    ...
    void listReturnsMultipleCondominiums() throws Exception {
        when(service.listForCurrentUser()).thenReturn(List.of(
                new CondominiumSummary(UuidV7Reference.randomUUID(), "Condo A", UserRoleInCondo.OWNER),
                new CondominiumSummary(UuidV7Reference.randomUUID(), "Condo B", UserRoleInCondo.TENANT)));
