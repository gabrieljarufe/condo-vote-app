...
class GlobalExceptionHandlerTest {
    ...
    static class TestController {
        ...
        @GetMapping("/conflict")
        void conflict() { throw new DataIntegrityViolationException("uk_violation"); }

        @GetMapping("/forbidden")
        void forbidden() { throw new ForbiddenException("acesso negado"); }

        @GetMapping("/not-found")
        void notFound() { throw new NotFoundException("recurso não encontrado"); }
